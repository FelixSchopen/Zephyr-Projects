...
void isr_setup(void){
	...
	gpio_pin_interrupt_configure_dt(&limit_sw_hor0_spec, GPIO_INT_EDGE_BOTH);
	...
	gpio_pin_interrupt_configure_dt(&limit_sw_hor1_spec, GPIO_INT_EDGE_BOTH);
    ...
    gpio_pin_interrupt_configure_dt(&limit_sw_ver0_spec, GPIO_INT_EDGE_BOTH);
	...
	gpio_pin_interrupt_configure_dt(&limit_sw_ver1_spec, GPIO_INT_EDGE_BOTH);
